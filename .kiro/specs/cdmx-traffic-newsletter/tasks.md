...
- [ ] 3. Implementar Send Email Lambda con integración Zavu.dev
  ...
  - [x] 3.3 Implementar Lambda handler para envío de emails
...
- [x] 4. Checkpoint - Validar suscripción y envío básico
  - Probar flujo de suscripción end-to-end
  - Verificar que emails se envían correctamente vía Zavu
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Implementar Scraper Lambda para recopilación de datos
  - [x] 5.1 Crear estructura de TrafficIncident y funciones de scraping
    - Implementar dataclass TrafficIncident con validaciones
    - Crear scrape_traffic_sources() con manejo de múltiples fuentes
    - Implementar parsers para cada fuente de datos (ovial_cdmx, c5_cdmx)
    - Añadidos ScraperResponse, validate_incident_type(), validate_severity() en shared/
    - _Requirements: 3.1, 3.2, 3.3, 3.4, 9.3, 9.4, 9.5_

  - [x] 5.2 Implementar deduplicación de incidentes
    ...
    - Normalización de ubicación + bucket de 30 min + tipo
    - _Requirements: 3.6_

  - [x]* 5.3 Escribir property test para deduplicación
    - **Property 13: Incident Deduplication**
    - **Validates: Requirements 3.6**
    - 16 tests: idempotencia, subset, unicidad, colapso, preservación de distintos, bucketing, normalización

  - [x] 5.4 Agregar resiliencia y manejo de errores
...
- [x] 6. Implementar AI Content Generator Lambda
  - [x] 6.1 Crear integración con OpenAI/Bedrock
  ...
  - [x] 6.2 Implementar generación de contenido estructurado
  ...
  - [x]* 6.3 Escribir property test para completitud de contenido
    - **Property 14: Newsletter Content Completeness**
    - **Validates: Requirements 4.1, 4.2, 4.3, 9.6**
  
  - [x] 6.4 Agregar fallback template-based
    - Crear template simple para cuando AI falla
    - Implementar retry logic (3 intentos)
    - _Requirements: 4.7, 10.4_

- [x] 7. Implementar Generate Newsletter Lambda (orquestador)
  - [x] 7.1 Crear función principal de orquestación
  ...
  - [x] 7.2 Implementar archivado en S3
  ...
  - [x] 7.3 Implementar consulta y envío a suscriptores
...
- [x] 10. Implementar Get Sample Newsletter Lambda y endpoint
  - [x] 10.1 Crear función para obtener último newsletter de S3
    - Implementar get_latest_newsletter_from_s3()
    - Ordenar por timestamp para obtener el más reciente
    - _Requirements: 8.2_

  - [x] 10.2 Crear Lambda handler para GET /sample-newsletter
    - Implementar lambda_handler con headers CORS
    - Retorna JSON con html_content para compatibilidad con frontend
    - _Requirements: 8.1, 8.3, 8.4_

- [x] 11. Implementar funcionalidad de unsubscribe
  - [x] 11.1 Crear endpoint POST /unsubscribe
    - Validar unsubscribe_token (token o email)
    - Marcar subscriber como inactive (active='false')
    - Soporta lookup por token (desde link de email) y por email (desde frontend)
...
- [x] 12. Crear landing page estática
  - [x] 12.1 Diseñar HTML/CSS para landing page
  ...
  - [x] 12.2 Implementar JavaScript para integración con API
  ...
  - [x] 12.3 Configurar S3 + CloudFront para hosting
